...
<html lang="en">
  ...
  <body>
    ...
    <div class="blog-masthead">
      <div class="container">
        <nav class="blog-nav">
          <a class="blog-nav-item active" href="<?php echo __() ?>">Home</a>
          <a class="blog-nav-item" href="<?php echo __('news') ?>">New features</a>
          <a class="blog-nav-item" href="<?php echo __('press') ?>">Press</a>
          <a class="blog-nav-item" href="<?php echo __('hires') ?>">New hires</a>
          <a class="blog-nav-item" href="<?php echo __('about') ?>">About</a>
        </nav>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-8 blog-main">
          ...
          <div class="blog-post">
            <h2 class="blog-post-title"><a href="<?php echo $item->link ?>"><?php echo $item->title ?></a></h2>
            <p class="blog-post-meta"><?php echo date('F n, Y', $item->created) ?> by <a href="#">Mark</a></p>
